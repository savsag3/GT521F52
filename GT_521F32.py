...
class PyFingerprint_GT_521F32(object):
    """
        This is the class that initiates the conversation with the fp_scanner GT-521F32.
...
#TODO: Are @password and @address realy necessary for this sensor?
    #def __init__(self, port = '/dev/tty.usbserial-FTZ2AE1U', baudRate = 9600):
    #def __init__(self, port = '/dev/tty.usbserial-DO00BECT', baudRate = 9600):
    ...
    def writePacket(self,cmd_packet):
        ...
        for tempi in range(12):
            logger.debug(cmd_packet.packet_bytes[tempi])
